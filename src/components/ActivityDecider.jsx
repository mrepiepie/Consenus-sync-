...
import { 
  ...
  ChevronRight, RefreshCw, Layers, CheckCircle2 
} from 'lucide-react';
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="border border-gray-850 bg-slate-900/30 backdrop-blur-md p-6 rounded-2xl">
            ...
            <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
              {options.map(opt => (
                <div key={opt} className="flex justify-between items-center bg-slate-950/60 p-3 rounded-xl border border-gray-850 text-sm">
              ...
              {participants.map(p => (
                <div 
                  ...
                  className={`flex justify-between items-center p-3.5 rounded-xl border text-sm cursor-pointer transition ${
                    ...
                    ? 'bg-indigo-950/20 border-indigo-550/80 shadow-md shadow-indigo-500/5' 
            ...
            {results.winner ? (
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {results.ranked.map((r, i) => (
                      <div key={r.name} className="flex justify-between items-center bg-slate-950 p-3 rounded-xl border border-gray-850">
                ...
                {results.vetoes.length > 0 && (
                  <div className="bg-red-950/10 border border-red-500/10 p-4 rounded-xl flex gap-3 text-xs text-red-300">
